/**
 * PLA-1094 — optional read-only intake PAT (separation of duties).
 *
...
describe("PLA-1094 intake PAT separation of duties", () => {
  ...
  it("AC6: export always resolves githubPatSecretId, even when intakePatSecretId is set", async () => {
    ...
    await handlers["cad.export"](
      { artifactId, format: "step" as const, paperclipTicketId: "PLA-1094", toolCallId: "call-1" },
      DEFAULT_RUN_CTX,
    );
