/**
 * CAD scan intake-fetch — PLA-1089 Ask 1 (cross-company request DPR-192/196).
 *
 ...
 *
 * ## Security surface (BLOCKING SecurityEngineer review — PLA-1089 gate)
 *
 ...
 *
 * Caps below are the PLA-1089 proposal (~50 MiB/file, ~3 files); the total cap is
...
// ---------------------------------------------------------------------------
// Caps (PLA-1089 — confirm with SecurityEngineer)
// ---------------------------------------------------------------------------
