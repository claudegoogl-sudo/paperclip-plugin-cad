...
const manifest: PaperclipPluginManifestV1 = {
  ...
  description:
    ...
    "v0.1.0 scope: cad_render (script to artifact path) and cad_commit " +
    "(artifact path to GitHub commit). See SKILL.md for invocation schemas.",
  author: "Platform",
  ...
  tools: [
    {
      ...
      description:
        ...
        "Used for end-to-end verification of the plugin tool dispatch path (PLA-53).",
      parametersSchema: {
        type: "object",
        properties: {
          name: {
    ...
    },
    {
      ...
      description:
        ...
        "as a STEP/STL artifact path. The script runs in an isolated subprocess.",
      parametersSchema: {
        type: "object",
        properties: {
          script: {
    ...
    },
    {
      ...
      description:
        ...
        "and return the commit SHA. artifactPath must be inside the system temp directory.",
      parametersSchema: {
        type: "object",
        properties: {
          artifactPath: {
