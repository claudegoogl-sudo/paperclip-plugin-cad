/**
 * Tests for 55 (cad.run_script + cad.export tool API surface) and
 * 56 (artifact persistence pipeline — AC6 happy path updated for GitHub commit).
 *
...
// ---------------------------------------------------------------------------
// AC6: Happy path — run_script → export (56: GitHub commit result)
// ---------------------------------------------------------------------------
